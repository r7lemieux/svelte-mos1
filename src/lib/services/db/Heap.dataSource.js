...
exports.HeapDataSource = void 0;
var rezult_js_1 = require("../common/message/rezult.js");
var errorName_js_1 = require("../common/message/errorName.js");
var HeapDataSource = /** @class */ (function () {
    function HeapDataSource(moDef) {
        var _this = this;
        this.records = {};
        this.keyname = 'id';
        this.getMo = function (key) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.records[key]];
            });
        }); };
        ...
        this.getMos = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Object.values(this.records)];
            });
        }); };
    ...
    return HeapDataSource;
}());
exports.HeapDataSource = HeapDataSource;
