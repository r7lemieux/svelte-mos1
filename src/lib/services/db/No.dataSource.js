...
var db_service_js_1 = require("./db.service.js");
var rezult_js_1 = require("../common/message/rezult.js");
var errorName_js_1 = require("../common/message/errorName.js");
var NoDataSource = /** @class */ (function () {
    function NoDataSource(moDef) {
        var _this = this;
        this.records = new Map();
        this.db = new db_service_js_1.DbService();
        // getMo = async (key: any): Promise<M | undefined> => {
        this.getMo = function (id) { return __awaiter(_this, void 0, void 0, function () {
            var mo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [2 /*return*/, Promise.reject(new rezult_js_1.Rezult(errorName_js_1.ErrorName.not_implemented_in_default))];
                    case 1: return [4 /*yield*/, this.db.getMo(this.moDef.dbName, id)];
                    case 2:
                        mo = _a.sent();
                        if (mo) {
        ...
        this.getMos = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.getMos(this.moDef.dbName)];
                    case 1:
                        mos = _a.sent();
                        if (mos) {
