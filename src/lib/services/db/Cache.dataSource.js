...
var CacheDataSource = /** @class */ (function () {
    function CacheDataSource(moDef, ds) {
        var _this = this;
        ...
        this.getMo = function (id) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1: return [4 /*yield*/, this.ds.getMo(id)];
                    case 2:
                        mo = _a.sent();
                        if (mo) {
        ...
        this.saveMo = function (mo) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.ds.saveMo(mo)
                        .then(function (mo) {
                        if (mo) {
        ...
        this.updateMo = function (mo) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (!mo)
                    throw new rezult_js_1.Rezult(errorName_js_1.ErrorName.missing_param);
                return [2 /*return*/, this.ds.updateMo(mo)
                        .then(function (mo) {
                        if (mo) {
                            _this.records.set(mo.id, mo);
                        }
        ...
        this.addMo = function (mo) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (!mo)
                    throw new rezult_js_1.Rezult(errorName_js_1.ErrorName.missing_param);
                return [2 /*return*/, this.ds.addMo(mo)
                        .then(function (mo) {
                        if (mo) {
                            _this.records.set(mo.id, mo);
                        }
        ...
        this.getMos = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ds.getMos()];
                    case 1:
                        mos = _a.sent();
                        if (mos) {
        ...
        this.saveMos = function (givenMos) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ds.saveMos(givenMos)];
                    case 1:
                        savedMos = _a.sent();
        ...
        this.deleteMo = function (id) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ds.deleteMo(id)];
                    case 1:
                        _a.sent();
